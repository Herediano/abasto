 ...
 *
 * El ingreso por factura de proveedor NO vive acá: es Compras, su propio
 * módulo (permisos `compras.*`, no `stock.mover`) — cargar una factura es una
 * operación de compra, no un movimiento de depósito.
 */
