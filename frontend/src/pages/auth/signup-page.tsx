...
export function SignupPage() {
  ...
  return (
    <AuthLayout title="Crear tu mayorista" description="Registrá la empresa y el primer usuario administrador.">
      {error && <Alert variant="destructive">{error}</Alert>}
      <form className="grid gap-4" onSubmit={submit}>
        <Field label="Nombre del mayorista" htmlFor="tenantName">
