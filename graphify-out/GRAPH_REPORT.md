...
## Corpus Check
- 221 files · ~127,530 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1585 nodes · 4071 edges · 104 communities (76 shown, 9 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 149 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6b993ef0`
...
### Community 0 - "api.ts"
Cohesion: 0.05
Nodes (149): EmptyState(), ExportMenu(), download(), Field(), PermissionRoute(), FullScreenRoute(), ProtectedRoute(), PageHeader() (+141 more)
...
Cohesion: 0.13
Nodes (23): JwtAuthGuard, Injectable, TIMEZONES, AuthUser, TIPOS_MOVIMIENTO, Usuario, CuentasCorrientesService, Inject (+15 more)
...
Cohesion: 0.07
Nodes (38): BranchSwitcher(), CommandPalette(), norm(), EscritorioShell(), PaletteContext, usePalette(), activeBranchFor(), read() (+30 more)
...
### Community 33 - "api"
Cohesion: 0.12
Nodes (20): api, UsersPage(), submitCreate(), submitEdit(), iniciales(), PasswordSection(), submit(), PerfilSection() (+12 more)
...
Cohesion: 0.16
Nodes (17): AccountList(), iniciales(), haceCuanto(), iniciales(), inicioDeSesion(), UserMenu(), aplicarDensidad(), AVATAR_COLORS (+9 more)
...
### Community 51 - "sendExport"
Cohesion: 0.11
Nodes (16): csvCell(), ExportColumn, sendExport(), Res, SuppliersController, Body, Controller, Get (+8 more)
...
### Community 60 - "El escritorio"
Cohesion: 0.29
Nodes (7): Configurable, El celular, El escritorio, Estado tranquilo, La caja no es una tarjeta, La tarjeta — un solo molde para las ~14, Se arma por permiso
...
### Community 96 - "SucursalesSection"
Cohesion: 0.40
Nodes (3): SucursalesSection(), accion(), submit()

### Community 97 - "ExpirationsPage"
Cohesion: 0.40
...
## Knowledge Gaps
- **331 isolated node(s):** `name`, `private`, `start:dev`, `start`, `db:generate` (+326 more)
...
- **Why does `AuthService` connect `AuthService` to `app.module.ts`, `.token`, `AuthRequest`, `Mayorista ERP Project Overview`?**
  _High betweenness centrality (0.245) - this node is a cross-community bridge._
- **Why does `AuthRequest` connect `AuthRequest` to `SalesService`, `app.module.ts`, `AuthService`, `ProductsController`, `prices.service.ts`, `StockService`, `promotions.controller.ts`, `PurchasesController`, `PriceListsController`, `RequirePermission`, `CustomersController`, `Tenants Controller`, `BranchesController`, `RangosService`, `sendExport`, `SalesController`, `CategoriesController`, `ReportesController`, `EscritorioController`, `PriceRulesController`, `WarehousesController`?**
  _High betweenness centrality (0.142) - this node is a cross-community bridge._
- **Why does `errorMessage()` connect `errorMessage` to `api.ts`, `api`, `SucursalesSection`, `ExpirationsPage`, `EmpresaSection`, `SuppliersPage`, `PosPage`, `.token`, `WarehousesPage`, `RangosPage`, `SalesHistoryPage`, `StockInPage`, `SupervisorAuthDialog`?**
